...
-- Scroll inside floating LSP windows
vim.keymap.set({ "n", "i" }, "<C-f>", function()
    return vim.lsp.util.scroll(4)
...
vim.lsp.enable({
    ...
    'clangd',
    'jdtls',
    'ts_ls', -- Uncomment if you enable JS/TS above
    'sqlls',
    'bashls',
    'lua_ls',
    'rust_analyzer',
...
-- legacy lspconfig setup (if needed)
